...
```
curl "https://nubesgen.com/acme-fitness-store.zip?iactool=TERRAFORM&region=eastus&application=SPRING_CLOUD.standard&runtime=DOCKER&database=POSTGRESQL.general_purpose&addons=key_vault,redis&network=VIRTUAL_NETWORK" | tar -xzvf -
```
